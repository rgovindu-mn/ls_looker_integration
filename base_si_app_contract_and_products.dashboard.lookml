- dashboard: si_app_contract_and_products
  ...
  filters:
   ...
   - name: customer_name
     ...
     default_value:
     field: mn_customer_dim2.customer_name
...
#        elig_customer_name: mn_eligible_customer_dim.customer_name
    ...
    - name: contract_header
      ...
      model: base_sales_intelligence_app_model
      explore: mn_pg_product_pricing_fact
      dimensions: [mn_customer_account_dim.customer_name, mn_contract_header_dim.contract_name,
      ...
      listen:
        elig_customer_name: mn_eligible_customer_dim.customer_name
        customer_name: mn_customer_account_dim.customer_name
