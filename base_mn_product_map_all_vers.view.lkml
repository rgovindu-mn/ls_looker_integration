view: mn_product_map_all_vers {
  derived_table: {
    sql: SELECT
        ...
        ,TO_DATE(LEVEL0_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL0_PROD_START_DT
        ,TO_DATE(LEVEL0_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL0_PROD_END_DT
        ,AV.LEVEL1_PROD_WID
        ,P_L1.PRODUCT_NAME P_L1_PRODUCT_NAME
        ,P_L1.PRODUCT_NUM P_L1_PRODUCT_NUM
        ,TO_DATE(LEVEL1_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL1_PROD_START_DT
        ,TO_DATE(LEVEL1_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL1_PROD_END_DT
        ,AV.LEVEL2_PROD_WID
        ,P_L2.PRODUCT_NAME P_L2_PRODUCT_NAME
        ,P_L2.PRODUCT_NUM P_L2_PRODUCT_NUM
        ,TO_DATE(LEVEL2_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL2_PROD_START_DT
        ,TO_DATE(LEVEL2_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL2_PROD_END_DT
        ,AV.LEVEL3_PROD_WID
        ,P_L3.PRODUCT_NAME P_L3_PRODUCT_NAME
        ,P_L3.PRODUCT_NUM P_L3_PRODUCT_NUM
        ,TO_DATE(LEVEL3_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL3_PROD_START_DT
        ,TO_DATE(LEVEL3_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL3_PROD_END_DT
        ,AV.LEVEL4_PROD_WID
        ,P_L4.PRODUCT_NAME P_L4_PRODUCT_NAME
        ,P_L4.PRODUCT_NUM P_L4_PRODUCT_NUM
        ,TO_DATE(LEVEL4_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL4_PROD_START_DT
        ,TO_DATE(LEVEL4_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL4_PROD_END_DT
        ,AV.LEVEL5_PROD_WID
        ,P_L5.PRODUCT_NAME P_L5_PRODUCT_NAME
        ,P_L5.PRODUCT_NUM P_L5_PRODUCT_NUM
        ,TO_DATE(LEVEL5_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL5_PROD_START_DT
        ,TO_DATE(LEVEL5_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL5_PROD_END_DT
        ,AV.LEVEL6_PROD_WID
        ,P_L6.PRODUCT_NAME P_L6_PRODUCT_NAME
        ,P_L6.PRODUCT_NUM P_L6_PRODUCT_NUM
        ,TO_DATE(LEVEL6_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL6_PROD_START_DT
        ,TO_DATE(LEVEL6_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL6_PROD_END_DT
        ,AV.LEVEL7_PROD_WID
        ,P_L7.PRODUCT_NAME P_L7_PRODUCT_NAME
        ,P_L7.PRODUCT_NUM P_L7_PRODUCT_NUM
        ,TO_DATE(LEVEL7_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL7_PROD_START_DT
        ,TO_DATE(LEVEL7_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL7_PROD_END_DT
        ,AV.LEVEL8_PROD_WID
        ,P_L8.PRODUCT_NAME P_L8_PRODUCT_NAME
        ,P_L8.PRODUCT_NUM P_L8_PRODUCT_NUM
        ,TO_DATE(LEVEL8_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL8_PROD_START_DT
        ,TO_DATE(LEVEL8_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL8_PROD_END_DT
        ,AV.LEVEL9_PROD_WID
        ,P_L9.PRODUCT_NAME P_L9_PRODUCT_NAME
        ,P_L9.PRODUCT_NUM P_L9_PRODUCT_NUM
        ,TO_DATE(LEVEL9_PROD_START_DT_WID,'RRRRMMDD') AS LEVEL9_PROD_START_DT
        ,TO_DATE(LEVEL9_PROD_END_DT_WID,'RRRRMMDD') AS LEVEL9_PROD_END_DT
        ,AV.RUN_ID
        ,AV.SOURCE_SYSTEM_ID
        ,AV.DATE_CREATED
        ,AV.DATE_UPDATED
